...
class Bootstrap {
    ...
    private function processRequest() {
        ...
        try {
            // w components[1] zawsze powinien znajdować
            // się nasz kontroler, dlatego próbujemy utworzyć obiekt
            // klasy wg podanej nazwy
        ...
        $this->controller = new
            $controllerClass($this->action, $this->argument);
        }
        catch (Exception $e) {
            $this->action = 'error';
